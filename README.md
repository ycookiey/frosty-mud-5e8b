...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-mud-5e8b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-mud-5e8b
```

A live public deployment of this template is available at [https://frosty-mud-5e8b.templates.workers.dev](https://frosty-mud-5e8b.templates.workers.dev)
